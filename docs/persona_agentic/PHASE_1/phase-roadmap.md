...
| **Identity** | Orchestrator-issued container tokens (validated against internal registry) | SPIRE with Docker PID attestation, SVID type policy (x509/JWT), aggressive TTLs | Full PKI (HSM root CA, intermediate CA), deny-list revocation, replay protection |
