...
| **Security Guardrails** | Access control, container sandbox, enforcement boundaries | [[arch-security-guardrails]] |
| **Container Lifecycle** | Provision, configure, start, monitor, recycle | [[arch-container-lifecycle]] |
